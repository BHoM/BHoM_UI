...
{
    public class QueryGeometry3DBarCaller : Caller
    {
        /*************************************/
        /**** Properties                  ****/
        /*************************************/
        public override System.Drawing.Bitmap Icon_24x24 { get; protected set; } = Properties.Resources.CreateBHoM;
        public override Guid Id { get; protected set; } = new Guid("5E1C951C-EAF4-4150-B329-A6D49ADE1BD7");

        public override string Name { get; protected set; } = "Geometry3DBar";

        public override string Category { get; protected set; } = "Structures";  // <-- This puts it in the "Structures" tab

        public override string Description { get; protected set; } = "Gets the BH.oM.Geometry.Extrusion out of the Bar as its Geometry3D.";
        ...
        public QueryGeometry3DBarCaller() : base()
        {

            MethodInfo geometryMethod = typeof(BH.Engine.Structure.Query)
                .GetMethods()
                .Where(m => m.Name == "Geometry3D")
                .Where(m => m.GetParameters().FirstOrDefault()?.ParameterType == typeof(Bar))
                .FirstOrDefault();
